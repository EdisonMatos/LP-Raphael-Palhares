  ...
  const getNavbarClasses = () => {
    if (colorMode === "light") {
      return scrolling
        ...
        : "bg-transparent desktop1:bg-white";
    }
    if (colorMode === "dark") {
      return scrolling
        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "w-[50%] max-w-[50%] tablet2:w-[50%] tablet2:max-w-[50%] desktop1:w-[40%] desktop2:w-[40%] transition-all duration-1000 "
                  : " rounded-md my-[5px] w-[70%] tablet1:w-[70%] tablet2:w-[70%] desktop1:w-[60%] desktop2:w-[60%] transition-all duration-1000 "
              } tablet3:mb-0`}
            />
          </ScrollLink>
